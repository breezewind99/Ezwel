...
<script type="text/javascript">
	...
	$(function ()
	{
		...
		$("select[name=bpart_code], select[name=mpart_code], select[name=spart_code], select[name=state] ").change(function() {
			// 기존 mon 중지 후 start
			stopMon();
			startMon();
		});
		...
		<form id="search">
			...
			<div class="ibox-content-util-buttons">
				<div class="ibox-content contentRadius1 conSize">
					...
					<div id="recDiv3">
						<div id="labelDiv">
							<label class="simple_tag">상태검색</label>
							<select class="form-control rec_form5" name="state">
								<option value="" selected="selected">전체</option>
								<option value="0">대기상태</option>
								<option value="1">통화상태</option>
								<option value="2">녹취불량</option>
							</select>
						</div>
					</div>
					<div id="recDiv3">
