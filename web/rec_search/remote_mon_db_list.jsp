...
<%
	...
	try
	{
		...
		String state = CommonUtil.getParameter("state");
...
<div class="grey_back1">
	...
	<div class="colRight">
		...
		<div class="colLeft"><span class="ext_squre01_2 colLeft"></span><span class="ext_text">대기상태</span></div>
		<div class="colLeft"><span class="ext_squre02_1 colLeft"></span><span class="ext_text">통화상태</span></div>
	...
	<%
		for(Map<String, Object> item : list)
		{
			...
			*/
			...
			if("0".equals(ch_status))		status_cls = "1_2";
			else if("1".equals(ch_status))	status_cls = "2_1";
			else							status_cls = "3";
			/*
			...
			*/
			...
			out.print("		<span class=\"colLeft ext_with\" title=\"" + spart_name + "\" >" + ComLib.getEllipsis(spart_name, 10) + "</span>\n");
...
<div class="grey_back2">
	...
	<div class="colLeft"><span class="ext_squre01_2 colLeft"></span><span class="ext_text">대기상태</span></div>
	<div class="colLeft"><span class="ext_squre02_1 colLeft"></span><span class="ext_text">녹취상태</span></div>
	<div class="colLeft"><span class="ext_squre03 colLeft"></span><span class="ext_text">녹취불량</span></div>
	<!--
   <div class="colLeft"><span class="ext_squre01_2 colLeft"></span><span class="ext_text">대기</span></div>
   <div class="colLeft"><span class="ext_squre02_1 colLeft"></span><span class="ext_text">인바운드</span></div>
