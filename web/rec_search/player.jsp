...
<%
	...
	try 
	{
		...
		String reason_code = CommonUtil.getParameter("_reason_code");//사유입력에 사용
		String reason_text = CommonUtil.getParameter("_reason_text");//사유입력에 사용
