...
<script type="text/javascript">
	...
	function reasonFormChk() {
		...
		console.log("사유코드 : " + $("#modalReasonForm select[name=reason_code]").val());
		console.log("사유내용 : " + $("#modalReasonForm select[name=reason_text]").val());
		$("#_reason_code").val($("#modalReasonForm select[name=reason_code]").val());
		$("#_reason_text").val($("#modalReasonForm select[name=reason_text]").val());
