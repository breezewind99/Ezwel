...
<script type="text/javascript">
	...
	{
		var colModel = [
			{ title: "사용자 PC IP", width: 400, dataIndx: "pc_ip",
				validations: [
					{ type: "minLen", value: "1", msg: "필수입력 사항입니다." },
				],
			}/*,
			{ title: "사용여부", width: 150, dataIndx: "use_yn",
				editor: {
					type: 'select',
		...
		var baseObj = getBaseGridOption("pcip_perm", "Y", "N", "Y", "Y");
	...
	<div class="row titleBar border-bottom2">
		...
		<ol class="breadcrumb" style="float:right;">
			 ...
			 <li class="active"><strong>PC-IP 접근권한</strong></li>
		</ol>
	</div>
	<!--title 영역 끝 -->
			...
			<div class="panel-heading">
				<div class="panel-options">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href="pcip_perm.jsp">PC-IP 접근권한</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="modal-content animated fadeIn">
						<form id="regi">
							<div class="modal-header">
								...
								<h4 class="modal-title">사용자 PC IP 등록</h4>
							</div>
