...
<%
	...
	try
	{
		...
		// get parameter
		String sort_idx = CommonUtil.getParameter("sort_idx", "user_name,rec_date");
		...
		sb.append("<td class=th>1분이상~3분미만</td>");
		sb.append("<td class=th>3분이상~3분미만</td>");
		...
		for(Map<String, Object> item : list)
		{
			...
			sum_one_three_cnt += Integer.parseInt(item.get("one_three_cnt").toString());
			sum_three_five_cnt += Integer.parseInt(item.get("three_five_cnt").toString());
			...
			*/
			...
			sb.append("<td>" + item.get("one_three_cnt") + "</td>");
			sb.append("<td>" + item.get("three_five_cnt") + "</td>");
		...
		if(list.size() > 0)
		{
			...
			sb.append("<td class=th>" + sum_one_three_cnt + "</td>");
			sb.append("<td class=th>" + sum_three_five_cnt + "</td>");
